...
const Density = () => {
    ...
    const { selectedCity, selectedCount, selectedCompanion, selectedActivity, selectedStyle } = location.state || {}; // 선택된 정보 가져오기
            ...
            <div style={{ textAlign: 'center', marginTop: '50px' }}>
                    ...
                    <div style={{ flex: 1 }}>
                        <button
                            ...
                            style={{
                                ...
                                backgroundColor: currentStyle === '빽빽' ? '#d3d3d3' : 'white',
                    ...
                    <div style={{ flex: 1 }}>
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '5px',
                                transition: 'background-color 0.3s',
                                backgroundColor: currentStyle === '널널' ? '#d3d3d3' : 'white',
                                width: '100%', // 버튼의 너비를 100%로 설정
                            }}
                        >
                            널널한<br />
                ...
                <button 
                    onClick={() => navigate('/companion', { 
                        state: { selectedCity, selectedCount, selectedCompanion, selectedStyle: currentStyle } 
                    })} 
